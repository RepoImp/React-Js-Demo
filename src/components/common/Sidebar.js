                ...
                <>
                        ...
                        <ul className="nav-list">
                            ...
                            <li className="profile" style={{ cursor: 'pointer' }}>
                                <a onClick={performLogout}>
                                    ...
                                    <span className="links_name" style={{ paddingLeft: '1rem' }}>{appConstant.logout}</span>
                                </a>
                                <span className="tooltip">{appConstant.logout}</span>
                            </li>
                        </ul>
                    ...
                    <section className="home-section">
                        <div className='mainchil'>
                            <i className='bx bx-menu' id="btn" ref={ref} style={{ color: colors.blue, cursor: 'pointer', fontSize: '2rem' }} />
